              ...
              <div className="space-y-8">
                ...
                <fieldset className="border border-slate-200 rounded-xl p-5 sm:p-6 space-y-4">
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-3 gap-5">
                    ...
                    {/* Country */}
                    <div>
                      <label htmlFor="examinationCountry" className="block text-xs font-semibold text-slate-700 mb-1.5">
                        Country <span className="text-red-500">*</span>
                      </label>
                      <div className="relative">
                        <select
                          name="examinationCountry"
                          id="examinationCountry"
                          value={formData.examinationCountry}
                          onChange={handleInputChange}
                          className="w-full px-3.5 py-2.5 bg-white border border-slate-300 rounded-lg text-xs font-medium text-slate-800 focus:ring-2 focus:ring-amber-500 focus:border-amber-500 outline-none appearance-none pr-8 cursor-pointer"
                        >
                    ...
                    <div>
                      <label htmlFor="destinationCountry" className="block text-xs font-semibold text-slate-700 mb-1.5">
                ...
                <fieldset className="border border-slate-200 rounded-xl p-5 sm:p-6 space-y-5">
                  ...
                  <div className="space-y-5">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-3 gap-5">
                      <div>
                        ...
                        <input
                          ...
                          } rounded-lg text-xs font-medium text-slate-800 focus:ring-2 focus:ring-amber-500 focus:border-amber-500 outline-none`}
                        />
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-3 gap-5">
                      <div>
                        <label htmlFor="nationality" className="block text-xs font-semibold text-slate-700 mb-1.5">
                      ...
                      <div>
                        <label htmlFor="maritalStatus" className="block text-xs font-semibold text-slate-700 mb-1.5">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-3 gap-5">
                      <div>
                        <label htmlFor="passportNumber" className="block text-xs font-semibold text-slate-700 mb-1.5">
                        ...
                        <input
                          ...
                          } rounded-lg text-xs font-medium uppercase tracking-wider text-slate-800 focus:ring-2 focus:ring-amber-500 focus:border-amber-500 outline-none`}
                        />
                        {errors.passportNumber && <p className="mt-1 text-[11px] text-red-500">{errors.passportNumber}</p>}
                      </div>

                      <div>
                        <label htmlFor="confirmPassportNumber" className="block text-xs font-semibold text-slate-700 mb-1.5">
                      ...
                      <div>
                        <label htmlFor="passportIssueDate" className="block text-xs font-semibold text-slate-700 mb-1.5">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-3 gap-5">
                      <div>
                        <label htmlFor="passportIssuePlace" className="block text-xs font-semibold text-slate-700 mb-1.5">
                      ...
                      <div>
                        <label htmlFor="passportExpiryDate" className="block text-xs font-semibold text-slate-700 mb-1.5">
                      ...
                      <div>
                        <label htmlFor="visaType" className="block text-xs font-semibold text-slate-700 mb-1.5">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-3 gap-5">
                      ...
                      <div>
                        <label htmlFor="nationalId" className="block text-xs font-semibold text-slate-700 mb-1.5">
                    ...
                    <div>
                      <label htmlFor="positionApplied" className="block text-xs font-semibold text-slate-700 mb-1.5">
